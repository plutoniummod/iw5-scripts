...
_id_6116()
{
    ...
    {
        wait 1.5;
        self._id_6117 = common_scripts\utility::spawn_tag_origin();
        self._id_6117 makeusable();
        self._id_6117 sethintstring( &"PLATFORM_HOLD_TO_USE" );
        self._id_6117 waittill( "trigger" );
