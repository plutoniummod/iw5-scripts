...
blockarea( var_0 )
{
    var_1 = getentarray( "mp_tdm_spawn", "classname" );
    blockentsinarea( var_1, var_0 );
    var_1 = getentarray( "mp_dm_spawn", "classname" );
    blockentsinarea( var_1, var_0 );
}
...
blockentsinarea( var_0, var_1 )
{
    ...
    {
        if ( !isdefined( var_0[var_2].script_destructable_area ) || var_0[var_2].script_destructable_area != var_1 )
            continue;

        var_0[var_2].blockedoff = 1;
    }
}
